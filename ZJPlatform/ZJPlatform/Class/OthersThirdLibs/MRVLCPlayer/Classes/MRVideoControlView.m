...
- (void)layoutSubviews
{
    ...
    self.moreButton.frame        = CGRectMake(CGRectGetWidth(self.bounds) - CGRectGetWidth(self.moreButton.bounds) , CGRectGetMinX(self.topBar.bounds) , CGRectGetWidth(self.moreButton.bounds), CGRectGetHeight(self.moreButton.bounds));
...
- (void)setupView {
    ...
    [self.topBar    addSubview:self.moreButton];
...
-(BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch{
    if(touch.view == self.bottomBar  || touch.view == self.progressSlider || [self.bottomBar.subviews containsObject:touch.view])
        return NO;
    else
        return YES;
}
...
- (MRProgressSlider *)progressSlider
{
    if (!_progressSlider) {
        ...
        [_progressSlider setMinimumTrackTintColor:MainYellowColor];
